;===============================================================================
; Problem Statement:
; Write an ARM assembly program to add two 64-bit numbers and store the result
; using two registers.
;
; Input:
...
; R5 - Higher byte of result (with carry from lower byte addition)
;
; Test Cases:
; Test Case 1:
; Input: First number = 0x20000001F2345678, Second number = 0x0000002200000012
; Expected Output: R4 = 0xF234568A, R5 = 0x20000024
;
; Test Case 2:
; Input: First number = 0xFFFFFFFFFFFFFFFF, Second number = 0x0000000000000001
; Expected Output: R4 = 0x00000000, R5 = 0x00000000 (with carry flag set)
;===============================================================================
