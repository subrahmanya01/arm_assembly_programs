;===============================================================================
; Problem Statement:
; Find the largest number among five 32-bit numbers using direct comparisons
...
;
; Output:
; R5 - Greatest number among the five inputs
;
; Test Cases:
; Test Case 1:
; Input: R0 = 0x00000002, R1 = 0x00000003, R2 = 0x00000001
;        R3 = 0x00000006, R4 = 0x00000005
; Expected Output: R5 = 0x00000006
;
; Test Case 2:
; Input: R0 = 0xFFFFFFFF, R1 = 0x80000000, R2 = 0x00000000
;        R3 = 0x7FFFFFFF, R4 = 0x00000001
; Expected Output: R5 = 0xFFFFFFFF
;===============================================================================
